...
router.get("/realtimeproducts",passportCall("jwt"), viewsControllers.getRealTimeProducts);

router.get("/chat",passportCall("jwt"),authorization('admin') ,viewsControllers.chat);

router.get("/products",passportCall("jwt") , viewsControllers.getListProducts);

router.get("/cart/:cid", passportCall("jwt"), viewsControllers.getCart);

router.get("/productdetail", passportCall("jwt"), viewsControllers.productDetail);

router.get("/login", viewsControllers.login);

router.get("/register", publicAccess, viewsControllers.register);

router.get("/current",passportCall("jwt"),authorization('admin'),viewsControllers.getCurrent)
